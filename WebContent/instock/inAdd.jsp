...
<body>
	<form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/instock/instockAdd.do" id="form_goods_add" style="width:550px;margin:20px auto">
	<div class="form-group">
	    <label for="goodscode" class="col-sm-3 control-label">出库编号：</label>
	    <div class="col-sm-9">
	     	 <input type="text" class="form-control" id="goodscode" name="inCode" placeholder="请输入出库编号">
	    </div>
	 </div>
	 <div class="form-group">
	    <label for="goodsname" class="col-sm-3 control-label">出库数量：</label>
	    <div class="col-sm-9">
	     	 <input type="text" class="form-control" id="goodsname" name="inCount" placeholder="请输入出库数量">
	    </div>
	  </div>
	<div class="form-group">
	    <label for="goodsprice" class="col-sm-3 control-label">出库状态：</label>
	    <div class="col-sm-9">
	     	 <input type="text" class="form-control" id="goodsprice" name="inStatus" placeholder="请输入出库状态">
	    </div>
	  </div>
	  <div class="form-group">
